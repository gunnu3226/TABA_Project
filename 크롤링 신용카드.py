...
#데이터로 저장할 파일 생성, 접근
with open('/Users/gunnu/Desktop/크롤링/card_data.csv', 'w', encoding='utf-8', newline='') as f:
    ...
    for i in range(1,72):
        if i  != 45:
            ...
            try:
                ...
                #데이터 csv파일로 저장
                card_data.writerow([card_id,card_name,card_brand,card_in_out,card_record,card_summary,card_image,'신용카드'])
            except:
                continue
            #크롤링 로딩 대기시간
            time.sleep(5)
